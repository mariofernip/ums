...
<div class="profile">
		...
		<table class="tab_one">
			...
			<tr>
				...
				<td><a href="admin_single_student_update.php?id=<?php echo $row['st_id'];?>"><button class="editbtn">Editar Perfil</button></a></td>
			</tr>
			<?php  } ?>
		</table>
		<div class="back fix">
			<p style="text-align:center"><a href="admin_all_student.php"><button class="editbtn">Regresar a la lista de aplicantes</button></a></p>
		</div>
