...
<div class="profile">
			<h3 style="font-size:18px;text-align:center;background:#1abc9c;color:#fff;padding:10px;margin:0">Actualizar Perfil</h3>							
				<?php
			...
			<div class="back fix">
				<p style="text-align:center"><a href="admin_all_student.php"><button class="editbtn">Regresar a Perfil del aplicante</button></a></p>
			</div>
</div>
